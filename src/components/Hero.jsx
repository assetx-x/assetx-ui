  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          Every Portfolio Manager deserves an{' '}
        <span className="relative whitespace-nowrap text-sky-600">
          ...
          <span className="relative">Artificially Intelligent</span>
        </span>{' '}
          Analyst.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          Make data-driven decisions with confidence.
          This powerful tool utilizes advanced machine learning algorithms to extract meaningful insights and patterns from complex data sets.
      </p>
              ...
              >
                {group.map((company) => (
                  <li key={company.name} className="flex">
                    <img src={company.logo} alt={company.name} unoptimized />
                  </li>
                ))}
              </ul>
            </li>
