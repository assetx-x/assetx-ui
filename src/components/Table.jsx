    ...
    <>
      ...
      {paginated && (<nav className="mt-5 flex flex-row-reverse pb-20">
        <ReactPaginate
          ...
          previousLinkClassName={"px-3 py-2 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700"}
          ...
          disabledLinkClassName={"px-3 py-2 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 "}
