...
const NewPortfolioAnalysisResults = () => {
  ...
  const resultColumns = useMemo(() => [{
    Header: "Ticker",
    accessor: "ticker",
    Cell: ({ row }) => (<div className="flex items-center" onClick={() => console.log}>
        <img
    ...
    {
      Header: "AssetX Signal", accessor: "AssetX Signal", Cell: RecommendationPill
    }], []);

  const subCategoriesColumns = useMemo(() => [{
    Header: "Ticker",
    accessor: "ticker",
    Cell: ({ row }) => (<div className="flex items-center" onClick={() => handleRowClick(row.original.ticker)}>
        <img
          className="w-10 h-10 rounded-full"
          src={row.original.company_logo || "https://www.ortodonciasyv.cl/wp-content/uploads/2016/10/orionthemes-placeholder-image-2.png"}
          alt={row.original.company_name + " image"}
    ...
    Header: "Momentum Fast", accessor: "Momentum Fast"
  }, {
    Header: "Momentum Slow", accessor: "Momentum Slow"
  }, {
    Header: "Quality", accessor: "Quality"
  }, {
    Header: "Trend Following", accessor: "Trend Following"
  }, {
