      ...
      <div className="mt-6">
        <div className="relative overflow-x ">
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg p-3 h-[780px]">
            <h3 className="text-xl font-semibold">AI Selected Comparables</h3>

            <p className="text-gray-500 font-light mt-4 mb-4">
              Here are some other names to consider in your portfolio that I am
              currently bullish on based on your selected forecast horizon.
            </p>
